...
window.botpress.init({
                botId: "6c582ca0-dd95-46fa-8ff6-df82c6f78567",
                configuration: {
                    version: "v2",
                    composerPlaceholder: "Posez votre question...",
                    botName: "La Pinède ★★",
                    botAvatar: "https://files.bpcontent.cloud/2026/04/01/14/20260401141934-30ND7FD6.jpeg",
                    botDescription: "Idéalement situé au calme, niché dans un écrin de verdure face aux eaux turquoise de Barbicaja, probablement l’une des plus belles plages de sable fin de la cité impériale sur la route des Sanguinaires, l’hôtel 3 étoiles La Pinède à Ajaccio vous ouvre ses portes en Corse-du-Sud.",
					fabImage: "https://files.bpcontent.cloud/2026/04/01/14/20260401141958-E4LYUC57.jpeg",
                    website: { title: "Site Web", link: "https://www.la-pinede.com/" },
                    email: { title: "resa@la-pinede.com", link: "resa@la-pinede.com" },
                    phone: { title: "+33495520044", link: "+33495520044" },
                    termsOfService: {},
                    privacyPolicy: {},
                    color: "#BF975C",
                    variant: "solid",
                    additionalStylesheetUrl: "https://kenobi-project.github.io/assistant/hotel_lapinede-website_style.css",
                    headerVariant: "glass",
                    themeMode: "light",
                    fontFamily: "Inter",
                    radius: 2,
                ...
                clientId: "2a4debd3-7493-46b4-9728-e69bf3f1ab66",
                selector: "#webchat"
            });
